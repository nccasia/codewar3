...
{
    public abstract class AutoGenerateTestcaseWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AutoGenerateTestcaseWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AutoGenerateTestcaseWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AutoGenerateTestcaseDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AutoGenerateTestcaseDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AutoGenerateTestcaseDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AutoGenerateTestcaseDbContext, Task<T>> func)
        {
            T result;
