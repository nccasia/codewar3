...
namespace DRIMA.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly DRIMADbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = DRIMAConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(DRIMADbContext context)
        {
            _context = context;
        }
