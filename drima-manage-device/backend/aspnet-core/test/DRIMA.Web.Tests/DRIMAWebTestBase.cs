...
{
    public abstract class DRIMAWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DRIMAWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DRIMAWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DRIMADbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DRIMADbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DRIMADbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DRIMADbContext, Task<T>> func)
        {
            T result;
